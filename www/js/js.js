...
function menustripOff()
{
 ...
 //$('#video_help >li ').css("margin-right","0px")
 //$('#block-content-title').css("margin-left","-40px");
 //$('#block-footer').css("width","1140px");
 //$('#block-footer').css("margin-left","-40px");
}
function menustripOn()
{
    ...
    // $('.bgviolet').css("margin-left","0px");
// $('#video_help >li ').css("margin-right","5px")
// $('#block-content-title').css("margin-left","0px");
}
  ...
  ga('send', 'pageview');
      ...
      $('#form_reg').validate(
        ...
        function updateDeadline() {
			...
			var beforeDeadline = 'До сесії залишилось ';
			var onDeadline = 'Сесію розпочато!';
			...
			if ( diff > 0 ) {
				$deadlineTimer.html(beforeDeadline + days + ' днів ' + hours + ' годин ' + minutes + ' хвилин ' + seconds + ' секунд');
			} else {
